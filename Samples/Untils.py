...
Intra_Po_file_path = '../feature/Intra/Positive_features0701.xlsx'
Intra_Ne_file_path = '../feature/Intra/Negative_features0701.xlsx'
Inter_Po_file_path = '../feature/Inter/Positive_features0701.xls'
Inter_Ne_file_path = '../feature/Inter/Negative_features0701.xls'
...
def generate_intra_samples(Embedding_features, Cross_talk_features_path, Negative_features_path, Train_Sample_nums,
    ...
    merge_features(Train_Sample_nums, 500, True)
    merge_features(Test_Sample_nums, 140, False)


# generate_intra_samples(Embedding_features, Intra_Po_file_path, Intra_Ne_file_path, 5, 1, 'Intra/ML_727/Train',
#                        'Intra/ML_727/Test', 1)
# generate_intra_samples(Embedding_features, Intra_Po_file_path, Intra_Ne_file_path, 5, 1, 'Intra/WML_300/Train',
#                        'Intra/WML_300/Test', 2)
...
def generate_inter_samples(Embedding_features, Cross_talk_features_path, Negative_features_path, Train_Sample_nums,
    ...
    merge_features(Train_Sample_nums, 800, True)
    merge_features(Test_Sample_nums, 200, False)
...
# generate_inter_samples(Embedding_features, Inter_Po_file_path, Inter_Ne_file_path, 5, 1, './Inter/WML_3549/Train',
#                        './Inter/WML_3549/Test', 2)
